...
function getRating(watchList) {
  ...
  let averageRating = watchList.filter(char => char.Director == "Christopher Nolan").map(char => Number(char.imdbRating)).reduce((accumulator,value)=> accumulator += value)/watchList.filter(char => char.Director == "Christopher Nolan").length
